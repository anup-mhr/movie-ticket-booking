<%-- 
    Document   : showtime-add
    Created on : Apr 3, 2023, 10:28:42 AM
    Author     : Anup
--%>
            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    ...
                    <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        <li>
                            <a href="AdminController?page=showtime-add" class="active">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!-- Add Showtime Form -->
                                <form class="row g-3" action="AdminController?page=showtime-added" method="post">
                                    <div class="col-md-12">
                                        <div class="form-floating mb-3">
                                            <select class="form-select" id="floatingSelect" aria-label="State" name="movie">
                                            ...
                                            <label for="floatingSelect">Movie Name</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-floating mb-3">
                                            <select class="form-select" id="floatingSelect" aria-label="State" name="screen">
                                                <c:forEach items="${screens}" var="screen">
                                                <option value="${screen.screen_id}">${screen.name}</option>
                                                <!--<option value="2">DC</option>-->
                                                </c:forEach>
                                            </select>
                                            <label for="floatingSelect">Screen</label>
                                        </div>
                                    </div>       
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="floatingTime" name="start_time">
                                            <label for="floatingTime">Start Time</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="floatingTime" name="end_time">
                                            <label for="floatingTime">End Time</label>
                                        </div>
                                    </div>
