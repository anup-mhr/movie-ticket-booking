<%-- 
    Document   : showtime-remove
    Created on : Apr 3, 2023, 10:29:08 AM
    Author     : Anup
--%>
    ...
    <body>
            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-item">
                    ...
                    <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                        ...
                        <li>
                            <a href="AdminController?page=showtime-remove"  class="active">
        ...
        <main id="main" class="main">
            ...
            <div class="pagetitle">
                ...
                <h1>Remove Showtime</h1>   <!--update + connect database here-->
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                        <li class="breadcrumb-item">Showtime</li>   
                        <li class="breadcrumb-item active">Remove</li>  <!--update + connect database here-->
                    </ol>
                </nav>
            </div><!-- End Page Title -->
