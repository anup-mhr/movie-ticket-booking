<%-- 
    Document   : transactions-movie
    Created on : Apr 3, 2023, 10:25:48 AM
    Author     : Anup
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <title>Transactions / Movies</title>
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Data</li>  <!--update + connect database here-->
                    </ol>
                </nav>
            </div><!-- End Page Title -->
