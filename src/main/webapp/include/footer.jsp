<%-- 
    Document   : footer
    Created on : Mar 2, 2023, 12:52:33 PM
    Author     : Anup
--%>
...
<html>
    ...
    <body>
        <footer class="align-items-center justify-content-center">
            ...
            <div class="lower d-flex justify-content-center text-center py-3" >Copyright c 2023 Cinema. All Right Preserved. Developed By <p class="name mx-1">Anup Maharjan</p></div>
        </footer>
    </body>
</html>
